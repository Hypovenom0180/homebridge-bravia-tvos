...
class Bravia {
  ...
  async registerCall(user, cookie, refresh) {
    ...
    return new Promise((resolve, reject) => {
      ...
      var data = '{"method":"actRegister","params":[{"clientid":"BraviaTVOS:481b0a56-fcdf-4b13-bef7-dc22acf965ab","nickname":"BraviaTVOS (homebridge-sony-bravia)","level":"private"},[{"value":"yes","function":"WOL"}]],"id":8,"version":"1.0"}';
